...
(
	...
	(
		...
		WHERE u.Id = ''ff2cd947-a9ea-4a54-a3d5-473069ff0cce''
...
where (sg.NavNode = ''TeamWork'' OR COALESCE(WorkItem.AssignedUserId, ''00000000-0000-0000-0000-000000000000'') = ''ff2cd947-a9ea-4a54-a3d5-473069ff0cce'')
			and DisplayStringStatus.LocaleID = ''ENU''
