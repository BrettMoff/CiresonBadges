...
-- set the query title
DECLARE @QueryTitle nvarchar(255)  					= 'Active Work'
...
(
	...
	WHERE (''{{ShowActivities}}'' = ''True'' or WorkItem.ClassId not in (''7AC62BD4-8FCE-A150-3B40-16A39A61383D'', ''BFD90AAA-80DD-0FBB-6EAF-65D92C1D8E36'')) --dont include activities
)
